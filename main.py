...
class Main(MDApp):
    ...
    def change_nav_drawer_color(self,item):
        for i in self.builder.ids.boxes.children[1].children:
            if item == i:
                item.bg_color=(1,.5,.2,1)
            else:
                i.bg_color=(1,1,1,0)
    ...
    def show_shirts(self):
        ...
        for i in range(4):
            card = MDCard(
                        ...
                        size_hint = (None,.9),
                        width= dp(100),
                        on_release=lambda x, value=str('src/shirts/')+self.mainPageShirt_list[i]:  self.showProductInfo(value)
    ...
    def show_jacket_test(self):
        ...
        for i in range(4):
            card = MDCard(
                        ...
                        size_hint = (None,.9),
                        width= dp(100),
                        on_release=lambda x, value=str('src/jackets/')+self.mainPagejacket_list[i]:  self.showProductInfo(value)
    ...
    def show_hoody(self):
        ...
        for i in range(4):
            card = MDCard(
                        ...
                        size_hint = (None,.9),
                        width= dp(100),
                        on_release=lambda x, value=str('src/hoody/')+self.mainPageHoody_list[i]:  self.showProductInfo(value)
